...
[_VIM] = LAYOUT_ortho_4x12(
    ...
    KC_DEL,KC_LALT,KC_LGUI,KC_NO,_______,KC_BSPC,KC_SPC,KC_NO,KC_NO,KC_NO,KC_NO  
),
...
[_I3L] = LAYOUT_ortho_4x12(
    ...
    KC_DEL,KC_LALT,KC_LGUI,_______,KC_NO,KC_BSPC,LALT(KC_SPC),KC_NO,KC_NO,KC_NO,KC_NO    
),
...
[_MOU] = LAYOUT_ortho_4x12(
    ...
    KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,_______,KC_NO,KC_NO,KC_NO,
)
