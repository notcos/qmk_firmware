...
LSFT_T(KC_QUOT),  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                         KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH, RSFT_T(KC_MINS),
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                            MO(4),   MO(1),  MO(4) ,     KC_SPC,   MO(2), MO(3)
                                      //`--------------------------'  `--------------------------'
...
LSFT_T(KC_QUOT),KC_LBRC,KC_RBRC,LCTL(LSFT(KC_C)),LCTL(LSFT(KC_V)),KC_NO,         KC_HOME, KC_PGDN, KC_PGUP, KC_END ,  KC_NO , RSFT_T(KC_MINS),
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                           KC_NO , _______,  KC_NO ,     KC_SPC,   KC_NO, KC_NO
                                      //`--------------------------'  `--------------------------'
  ),
...
LSFT_T(KC_QUOT),KC_APP, KC_LALT,  KC_NO ,  KC_NO ,  KC_NO ,                       KC_NO ,  KC_NO , KC_COMM, KC_DOT , KC_SLSH,RSFT_T(KC_MINS),
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                           KC_NO ,  KC_NO , KC_DOT ,     KC_SPC, _______,  KC_NO
                                      //`--------------------------'  `--------------------------'
  ),
  ...
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                           KC_NO ,  KC_NO ,  KC_NO ,     KC_SPC,  KC_NO , _______
                                      //`--------------------------'  `--------------------------'
  ),
 ...
 KC_NO,LALT(KC_1),LALT(KC_2),LALT(KC_3),LALT(KC_4),LALT(KC_5),            LALT(KC_6),LALT(KC_7),LALT(KC_8),LALT(KC_9),LALT(KC_0),LALT(KC_ENT),
  ...
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                          _______,  KC_NO , _______,  LALT(KC_SPC),KC_NO,  KC_NO
                                      //`--------------------------'  `--------------------------'
  )
